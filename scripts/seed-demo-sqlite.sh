...
('10000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', 'Alex Chen', 'Full-stack .NET 顧問', '專注於 .NET、Angular 與企業內部系統建置。', 'Taipei', '每小時 NT$1,500，專案可議', 1),
('10000000-0000-0000-0000-000000000002', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', 'Bella Lin', 'UI/UX 與前端工程師', '擅長 React、設計系統、互動體驗優化。', 'New Taipei', '每案 NT$20,000 起', 1),
('10000000-0000-0000-0000-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', 'Chris Wu', '雲端架構與 DevOps 顧問', '提供 Azure / GCP 架構設計、CI/CD 與監控規劃。', 'Remote', '每小時 NT$2,000', 1);

INSERT INTO ClientProfiles (Id, UserId, DisplayName, CompanyName) VALUES
('20000000-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1', 'Demo Client', 'Demo Studio');

INSERT INTO PortfolioItems (Id, ProviderProfileId, Title, Description, ImageUrl, ExternalUrl, SortOrder) VALUES
('30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '企業排程系統', '協助企業建立內部排程與簽核平台。', '', 'https://example.com/alex-1', 1),
('30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'HR 管理後台', '整合簽核、排班、報表與權限管理。', '', 'https://example.com/alex-2', 2),
('30000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002', 'SaaS 設計系統', '建立元件庫與一致化的 UI 規範。', '', 'https://example.com/bella-1', 1),
('30000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000002', '預約平台前端重構', '優化預約流程與手機版操作體驗。', '', 'https://example.com/bella-2', 2),
('30000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000003', 'Azure Landing Zone', '建立多環境 Azure landing zone 與治理策略。', '', 'https://example.com/chris-1', 1),
('30000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000003', 'CI/CD 平台化', '設計多 repo 共用的部署流程與監控告警。', '', 'https://example.com/chris-2', 2);

INSERT INTO AvailabilitySlots (Id, ProviderProfileId, StartAt, EndAt, TimeZone, IsBooked) VALUES
('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '2026-04-06T09:00:00+08:00', '2026-04-06T10:00:00+08:00', 'Asia/Taipei', 0),
('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '2026-04-06T14:00:00+08:00', '2026-04-06T15:00:00+08:00', 'Asia/Taipei', 0),
('40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002', '2026-04-07T10:00:00+08:00', '2026-04-07T11:00:00+08:00', 'Asia/Taipei', 0),
('40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000002', '2026-04-07T16:00:00+08:00', '2026-04-07T17:00:00+08:00', 'Asia/Taipei', 0),
('40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000003', '2026-04-08T13:00:00+08:00', '2026-04-08T14:00:00+08:00', 'Asia/Taipei', 0),
('40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000003', '2026-04-09T09:00:00+08:00', '2026-04-09T10:00:00+08:00', 'Asia/Taipei', 0);
SQL
